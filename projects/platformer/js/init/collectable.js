(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 370, 0, 0);
        collectable.create(type.max, 816, 500, 0, 0);
        collectable.create(type.grace, 300, 200, 0, 0);
        collectable.create(type.kennedi, 110, 87, 0, 0);
